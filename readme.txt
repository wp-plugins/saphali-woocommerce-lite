...
* Добавленные произвольные поля теперь можно можно сортировать вместе со стандартными полями (устранена разрозненность сортировки полей, которые по умолчанию и тех, которые добавлены по надобности).
...
= 1.3.6 =
* Поле "Название компании" теперь можно отмечать как обязательное. Добавленные произвольные поля теперь можно можно сортировать вместе со стандартными полями (устранена разрозненность сортировки полей, которые по умолчанию и тех, которые добавлены по надобности).
* Исправлены некритичные ошибки.
