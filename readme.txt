...
* Русский интерфейс. <strong>Важное замечание!</strong> Мы более не исправляем русский перевод в плагине - https://wordpress.org/plugins/woocommerce/, т.к. он уже корректный. Перевод нашего плагина полезен тем, кто использует Woocommerce 2.0 и ниже, т.е. старые версии плагина.
...
также как вариант можете скачать файлы http://saphali.com/lang.zip и распаковав скопируйте их тогда сюда wp-content/languages/plugins
